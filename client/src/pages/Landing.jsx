      ...
      <nav className="bg-white/90 backdrop-blur-md shadow-lg border-b border-white/20 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-18 items-center">
            <div className="text-3xl font-bold text-gradient hover-glow transition-all duration-300 cursor-pointer">
              JobPortal
            </div>
              ...
              {user ? (
                <>
                  <Link
                    ...
                    className="px-6 py-2 text-indigo-600 hover:text-indigo-800 rounded-lg hover:bg-indigo-50 transition-all duration-200 font-semibold"
                  >
                    Dashboard
                  </Link>
                  <Link to="/jobs" className="px-6 py-2 text-indigo-600 hover:text-indigo-800 rounded-lg hover:bg-indigo-50 transition-all duration-200 font-semibold">
                    Browse Jobs
                  </Link>
                </>
              ) : (
                <>
                  <Link to="/login" className="px-6 py-2 text-indigo-600 hover:text-indigo-800 rounded-lg hover:bg-indigo-50 transition-all duration-200 font-semibold">
                    Login
                  </Link>
                  <Link
                    to="/signup"
                    className="btn-gradient text-white px-6 py-2 rounded-lg hover-lift font-semibold"
                  >
                    Sign Up
                  </Link>
                </>
